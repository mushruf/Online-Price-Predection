...
%>
    ...
    <table border="1" align="left" cellpadding="0" cellspacing="0" >
      <tr >
        ...
        <td width="187" height="27" bgcolor="#FFFF00" ><div align="center" class="style35"><span class="style17">Post Name</span> </div></td>
        <td><div align="center" class="style15 style17"><strong><%= p_Name%></strong></div></td>
      </tr>
      <tr/>
              <span class="style35">
              </tr>
      ...
      <tr>
        <td width="187" height="27" bgcolor="#FFFF00"><div align="center" class="style35"><span class="style17">Categorie</span> </div></td>
        <td><div align="center" class="style15 style17"><strong><%= categorie%></strong></div></td>
      </tr>
      <tr>
        <td width="187" height="27" bgcolor="#FFFF00"><div align="center" class="style35"><span class="style17">Rank </span> </div></td>
        <td><div align="center" class="style15 style17"><strong><%= p_Rank%></strong></div></td>
      </tr>
      <tr>
        <td width="187" height="27" bgcolor="#FFFF00"><div align="center" class="style17 style35">Description </div></td>
        <td><div align="center" class="style17 style15"><%= p_Desc1%></div></td>
      </tr>
      <tr> </tr>
      <tr>
...
%>
      ...
      <tr>
        <td height="30"><div align="center" class="style9 style10 style15"><%=rec_By%></div></td>
        <td><div align="center" class="style9 style10 style15"><%=rec_Details%></div></td>
        <td><div align="center" class="style9 style10 style15"><%=rec_date%></div></td>
      </tr>
...
%>
      ...
      <tr>
        ...
        <td valign="middle"><div align="center">
          <p>&nbsp;</p>
          <p><a href="user_AddReview.jsp?p_Name=<%=p_Name%>&amp;categorie=<%=categorie%>" class="style34 style33">Review</a>  <span class="style15">on Post</span></p>
          <p><a href="purchase.jsp?p_Name=<%=p_Name%>" class="style34 style33">Buy</a> <span class="style15">This Product </span></p>
               <p>&nbsp;</p>

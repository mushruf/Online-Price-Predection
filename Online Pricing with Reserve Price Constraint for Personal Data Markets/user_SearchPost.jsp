...
<div id="main">
  <div class="shell">
    <div id="templatemo_right_section">
            ...
            <table align="center" style="margin:0 0 0 30px;">
              <tr>
                <td width="174"><div align="center" class="style3">
                    <div align="right" class="style12">
                      <div align="center" class="style22">Enter Fuzzy Keyword</div>
                    </div>
                </div></td>
              ...
              <tr>
                <td colspan="3"><div class="style2">
                  <div align="center" class="style22">( searching content Based on Post Description)</div>
                </div></td>
              </tr>
            </table>
          </div>
      ...
      <p> </p>
      <div align="center" class="style11 style15"><span class="style4">Post Name : </span><span class="style16"> <%=p_Name%></span></div>
      </p>
      <p class="style15"> </p>
      <div align="center" class="style11 style15"><span class="style4">Categorie</span> <span class="style16"> : <span class="style22"><%=p_Categorie%></span></span></div>
      </p>
      <p class="style15"></p>
      <div align="center" class="style11"><span class="style4 style15">Post Rank </span><span class="style4">: </span> <span class="style16"> <%=p_Rank%></span></div>
      </p>
      <p></p>
      <div align="center" class="style5 style14"><span class="style11"><span class="style15">View :</span> <a href="user_ViewSearchedPost.jsp?p_Name=<%=p_Name%>&amp;keyword=<%=input%>" class="style14">Details</a></span></div>
      </p>
      <p></p>
      <div>

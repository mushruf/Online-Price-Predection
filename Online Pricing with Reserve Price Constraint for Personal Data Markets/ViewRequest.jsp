          ...
          <div class="box">
            <div class="entry">
              <table width="581" border="3"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse; margin:10px 0px 0px 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
                <tr>
                  <td  width="119" height="30" align="center" valign="bottom" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style22">Username</div></td>
                  <td  width="116" height="30" align="center" valign="bottom" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style22">Mobile</div></td>
                  <td  width="133" height="30" align="center" valign="bottom" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style22">Address</div></td>
                  <td  width="101" height="30" align="center" valign="bottom" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style22">Gender</div></td>
                  <td  width="138" height="30" align="center" valign="bottom" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style22">Status</div></td>
                </tr>
                <%
					...
					%>
                <tr>
                  <td  width="119" height="46" align="center" valign="middle" style="color:#000000;"><span class="style23">&nbsp;&nbsp;
                      <%out.println(s1);%>
                  </span></td>
                  <td  width="116" height="46" align="center" valign="middle"><span class="style23">&nbsp;&nbsp;
                    <%out.println(s3);%>
                  </span></td>
                  <td height="46" align="center"  valign="middle"><span class="style23">&nbsp;&nbsp;
                      <%out.println(s4);%>
                  </span></td>
                  <td height="46" align="center"  valign="middle"><span class="style23">&nbsp;&nbsp;
                      <%out.println(s6);%>
                  ...
                  <%
						...
						%>
                  <td  width="138" valign="middle" height="46" style="color:#000000;"align="center"><a href="updaterequest1.jsp?rid=<%=j%>" class="style23">waiting</a></td>
                  <%
						}
						else
						{
